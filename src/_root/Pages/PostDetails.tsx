    ...
    <div className='post_details-container'>
      {isPending ?<Loader/>:(
        <div className='post_details-card'>
          <img className='post_details-img ' alt='photh' src={post?.imageUrl}></img>
                ...
                <div className='flex flex-col '>
                    ...
                    <div className='flex-center gap-2 text-light-3'>
                        <p className='subtle-semibold lg:small-regular'>{multiFormatDateString(post?.creator.$createdAt)}</p>
                        -
